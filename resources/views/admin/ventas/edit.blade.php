...
<div class="row">
    <div class="col-md-12">
        <div class="card card-outline card-success">
            ...
            <div class="card-body">
                <form action="{{ url('/admin/ventas', $venta->id) }}" id="form_venta" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="nit_cliente_select" value="{{$venta->cliente->nit_codigo ?? 'S/N' }}" disabled>
                                    <input type="text" class="form-control" id="id_cliente" name="cliente_id" value="{{$venta->cliente->id ?? 'S/N' }}" hidden>
                                </div>
                                {{-- <hr> --}}
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" value="{{ old('fecha', $venta->fecha) }}" name="fecha" required>
                                        @error('fecha')
                                            <small style="color:red;">{{ $message }}</small>
                                        @enderror
                                    </div>
