...
<h1><b>Compras/registro de un nueva compra</b></h1>
<hr>
@stop
...
<div class="row">
    <div class="col-md-12">
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                <form action="{{ url('/admin/compras/create') }}" id="form_compra" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" id="id_proveedor" name="proveedor_id">
                                </div>
                                {{-- <hr> --}}
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('comprobante') }}" name="comprobante" required>
                                        @error('comprobante')
                                            <small style="color:red;">{{ $message }}</small>
                                        @enderror
                                    </div>
